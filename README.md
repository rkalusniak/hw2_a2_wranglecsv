...
For the remote repository, make a github repository named hw2_a2_wranglecsv, then do;

```bash
git remote add origin git@github.com:rkalusniak/hw2_a2_wranglecsv.git
git branch -M main
